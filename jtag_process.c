...
void jtag_gpio_init(void)
{
    ...
    bflb_gpio_init(gpio, TMS_PIN, GPIO_OUTPUT);
    bflb_gpio_init(gpio, TDI_PIN, GPIO_OUTPUT);
    bflb_gpio_init(gpio, TCK_PIN, GPIO_OUTPUT);
    bflb_gpio_init(gpio, TDO_PIN, GPIO_INPUT);
